  ...
  return (
    <nav className="flex items-center justify-between flex-wrap bg-indigo-700 h-20 w-screen px-5 fixed">
      <div className="flex flex-row flex-1 h-full items-center">
        <Link className="sm:w-20 flex items-center justify-center h-20 md:w-32 px-5 hover:bg-blue-500 " to="/cards">
          <span className="text-white">Cards</span>
        </Link>
        <Link className="sm:w-20 md:w-32 flex items-center justify-center h-19 px-5 hover:bg-blue-500" to="/myDeck">
